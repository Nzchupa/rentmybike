...
/**
 * DTO for updating an existing accessory — PUT /api/v1/accessories/{id}.
 * Full replace, same shape as create.
 * DTO zum Aktualisieren eines vorhandenen Zubehörs — PUT /api/v1/accessories/{id}.
 * Vollständiger Ersatz, gleiche Struktur wie beim Erstellen.
 */
@Data
