    ...
    <div className="space-y-8">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <Link href={`/${locale}/dashboard/bikes`} className="card p-5 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">{t("bikes.title")}</p>
            </div>
          </div>
        </Link>
        ...
        <Link href={`/${locale}/dashboard/bookings/renter`} className="card p-5 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">{t("tabs.asRenter")}</p>
            </div>
          </div>
        </Link>
        ...
        <Link href={`/${locale}/dashboard/bookings/owner`} className="card p-5 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${pendingCount > 0 ? "bg-amber-50" : "bg-slate-50"}`}>
              <CalendarCheck size={20} className={pendingCount > 0 ? "text-amber-600" : "text-slate-400"} />
            </div>
            <div>
              <p className="text-2xl font-bold text-slate-900">
                {pendingCount}
